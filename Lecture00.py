...
OPENMVG_SFM_BIN = "/home/vshenoy/openMVG_Build/Linux-x86_64-RELEASE"

# Indicate the openMVG camera sensor width directory
CAMERA_SENSOR_WIDTH_DIRECTORY = "/home/vshenoy/openMVG/src/software/SfM" + "/../../openMVG/exif/sensor_width_database"
...
input_eval_dir = os.path.dirname(os.path.abspath(__file__)) + "/imageDataset_ie"
output_eval_dir = os.path.join(get_parent_dir(input_eval_dir), "tutorial_out2")
...
pIntrisics = subprocess.Popen( [os.path.join(OPENMVG_SFM_BIN, "openMVG_main_SfMInit_ImageListing"),  "-i", input_dir, "-o", matches_dir, "-d", camera_file_params, "-c", "3", "-k", "831.0968;0;508.4419;0;824.1096;382.5426;0;0;1"] )
pIntrisics.wait()
